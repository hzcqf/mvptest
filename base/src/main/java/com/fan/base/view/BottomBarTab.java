...
//        typedArray.recycle();
    ...
    public void setSelected(boolean selected) {
        ...
        if (mIconRes != 0 && mSelectIconRes != 0) {
            if (selected) {
                mIcon.setImageResource(mSelectIconRes);
                mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.main_bottom_enable));
            } else {
                mIcon.setImageResource(mIconRes);
                mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.main_bottom));
            }
        } else {
            if (selected) {
